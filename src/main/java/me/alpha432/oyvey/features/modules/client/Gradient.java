...
public class Gradient
    ...
    public Gradient() {
        super("Gradient", "draws a gradient", Module.Category.CLIENT, true, false, false);
    }

    @Override
    public void onRender2D(Render2DEvent event) {
        ScaledResolution resolution = new ScaledResolution(Util.mc);
        if (Util.mc.currentScreen instanceof OyVeyGui && this.cgui.getValue().booleanValue() || this.always.getValue().booleanValue() || this.gui.getValue().booleanValue() && Util.mc.currentScreen instanceof OyVeyGui) {
