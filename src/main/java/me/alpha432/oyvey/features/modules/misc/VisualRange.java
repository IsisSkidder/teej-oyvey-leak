...
public class VisualRange extends Module
{
    ...
    public VisualRange() {
        super("Visual Range", "Tells you when a player enters your render distance", Category.MISC, false, false, false);
            ...
            for (final String playerName : tickPlayerList) {
                ...
                if (!this.knownPlayers.contains(playerName)) {
                    ...
                    if (OyVey.friendManager.isFriend(playerName)) {
                        this.sendNotification("Â§b" + playerName + TextUtil.coloredString(" Has entered your Visual Range!", HUD.getInstance().commandColor.getValue()));
                    }
                    else {
