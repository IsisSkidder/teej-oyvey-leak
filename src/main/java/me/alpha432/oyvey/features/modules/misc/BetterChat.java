...
public class BetterChat
    ...
    public final Setting<String> clientName = this.register(new Setting<>("ClientName", "", this::new1));
    ...
    public BetterChat() {
        super("Better Chat", "better chat", Module.Category.MISC, true, false, false);
        INSTANCE = this;
    }
