...
public class Trajectories
    ...
    private final Setting<Float> innerSize = this.register(new Setting<Float>("Inner Size", Float.valueOf(0.2f), Float.valueOf(-5.0f), Float.valueOf(5.0f)));
    public Setting slices = this.register(new Setting<Integer>("Slices", 9, 2, 100));
